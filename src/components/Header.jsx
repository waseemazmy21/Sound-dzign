...
const Header = () => {
  return (
    <header
      className='w-full h-screen max-h-[800px] bg-cover bg-bottom'
      style={{ backgroundImage: `url(${heroImage})` }}
    >
      <div className='container  h-screen max-h-[800px]'>
        <div className='relative  h-screen max-h-[800px]'>
          <div className='absolute right-0 bottom-0 w-[19rem] sm:w-[22.3rem] lg:w-[28.3rem] border-4 border-white border-b-0 bg-semiBlack backdrop-blur-[25px] p-[2.8rem_1.5rem] sm:p-[3.3rem_2.5rem_3.8rem] rounded-t-[1.25rem]'>
            <div className='mb-4'>
